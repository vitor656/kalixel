...
using StringTools;
using kalixel.extensions.FlxOgmo3LoaderExtended;

class FlxOgmo3LoaderExtended
{
	 ...
	 */
	public function loadTilemap(tileGraphic:Dynamic, tileLayer:String = "tiles", autoTile:FlxTilemapAutoTiling = FlxTilemapAutoTiling.OFF):FlxTilemap
	{
		...
		{
			case 0:
				tilemap.loadMapFromArray(layer.data, layer.gridCellsX, layer.gridCellsY, tileGraphic, tileset.tileWidth, tileset.tileHeight, autoTile);
			case 1:
